...
/* Dark theme: selected day — black text on gold */
:global([data-theme="dark"]) .cal-day.selected {
  background: var(--gold) !important;
  color: var(--bg-60) !important;  /* pure black */
  font-weight: 700;
}

/* Light theme: selected day — white text on gold */
:global([data-theme="light"]) .cal-day.selected {
  background: var(--gold) !important;
  color: var(--text-10) !important;  /* pure white */
  font-weight: 700;
}
